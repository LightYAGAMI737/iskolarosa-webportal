...
if (isset($_POST['ceap_reg_form_id'])) {
  ...
  if (mysqli_stmt_execute($stmtUpdate)) {
    ...
    echo "<script>console.error('An error occurred while updating file names: " . mysqli_error($conn) . "');</script>";
    echo "An error occurred while updating file names. Please try again later.";
  }
}
?>
