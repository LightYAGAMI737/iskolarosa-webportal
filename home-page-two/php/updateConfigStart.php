...
$sql = "SELECT id, start_date, start_time, end_date, end_time FROM ceap_configuration ORDER BY id DESC LIMIT 1";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($startDate !== '0000-00-00' && $startTime !== '00:00:00') {
        ...
        if (new DateTime($currentDateTime) >= new DateTime($endDate . ' ' . $endTime)) {
            ...
            $insertSql = "INSERT INTO ceap_configuration (toggle_value, start_date, start_time, qualifications, requirements) VALUES ($toggleValue, '$startDate', '$startTime', '$qualification', '$requirements')";
            ...
            $updateSql = "UPDATE ceap_configuration SET toggle_value = $toggleValue WHERE id = $configId";
