const RescheduleOLD = document.getElementById ('RescheduleOLDPopUp');

function openRescheduleOLD(){
    RescheduleOLD.style.display="block";
}
function closeRescheduleOLD(){
    RescheduleOLD.style.display="none";
    goBack();
}
...
ReschedulecancelButtons.forEach((ReschedulecancelButton) => {
  ReschedulecancelButton.addEventListener("click", closeRescheduleOLD);
});
