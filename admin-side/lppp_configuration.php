...
<ul class="navbar-nav">
      ...
      <form method="POST" action="./php/lpppconfigurationinsert.php">
        <div class="text-cont">
...
<div class="two-column-layout">
                <div class="column">
                    <div class="text-input">
                        ...
                        <textarea id="qualifications" name="qualifications" placeholder="Enter text here" maxlength="1000" rows="4" oninput="formatInput(this)"   required><?php echo ($qualifications) ?></textarea>
                    </div>
                </div>
                <div class="column">
                    <div class="text-input">
