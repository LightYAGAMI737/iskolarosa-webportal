...
<html lang="en">
   ...
   <body> 
    <?php
               ...
               <div class="left-section">
                  ...
                  <div class="right-section">
                     ...
                     <div class="button-section ">
                           ...
                           <!-- discard button -->
                           <div class="button-section ">
                           <button type="button" id="discardBtn" class="discard createpostBtn" onclick="opendiscard()" disabled>Discard</button>
                     </div>
                  </form>
               </div>
         </div>
      ...
      <script>
  // Function to check if any form fields have been modified
  function isFormModified() {
    // Add logic to check for modifications in form fields
    var title = document.getElementById('title').value;
    var description = document.getElementById('description').value;
    var image = document.getElementById('image').value; // input file
    var scheduledAt = document.getElementById('scheduled_at').value; // schedule

    // Check if all of the relevant fields are empty
    return title.trim() !== '' || description.trim() !== '' || image.trim() !== '' || scheduledAt.trim() !== '';
  }

  // Function to enable or disable the "Discard" button based on form modification
  function updateDiscardButton() {
    var discardButton = document.querySelector('.discard.createpostBtn');

    // Enable the button if the form is modified, otherwise disable it
    discardButton.disabled = !isFormModified();
  }

  // Add event listeners to relevant form fields
  document.getElementById('title').addEventListener('input', updateDiscardButton);
  document.getElementById('description').addEventListener('input', updateDiscardButton);
  document.getElementById('image').addEventListener('change', updateDiscardButton); // input file
  document.getElementById('scheduled_at').addEventListener('input', updateDiscardButton); // schedule
