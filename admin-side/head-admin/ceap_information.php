...
<div class="applicant-info">
    ...
    <table>
            ...
            <?php foreach ($applicantInfo as $field => $value) : ?>
                <?php if (in_array($field, ['control_number', 'last_name', 'first_name', 'middle_name', 'suffix_name', 'date_of_birth', 'age', 'gender', 'civil_status', 'place_of_birth', 'religion', 'contact_number', 'active_email_address', 'house_number', 'province', 'municipality', 'barangay'])) : ?>
                    <tr>
...
<button type="submit" name="update_all_info" class="status-button verified">Save Changes</button>
</div>
</div>
...
<div class="button-container">
    ...
    <button onclick="deleteApplicant(<?php echo $id; ?>)" class="status-button">Delete</button>
</div>
...
function deleteApplicant(applicantId) {
    if (confirm("Are you sure you want to delete this applicant?")) {
        ...
        $.ajax({
            type: "POST",
            url: "delete_applicant.php", // Replace with the actual URL to your PHP script
            data: {
                id: applicantId
            },
