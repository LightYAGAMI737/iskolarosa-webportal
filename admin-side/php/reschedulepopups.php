...
<!-- Reschedule OLD popup  -->
<div class="popupOut" id="RescheduleOLDPopUp">
    <div class="popupIn">
        <i class="ri-question-fill" style="font-size: 6em; color: #F54021;"></i>
        <strong>
            <h2>Reschedule Applicant? OLD</h2>
        </strong>
        <center>
            <p>Are you sure you want to proceed with the rescheduling of applicant(s)?</p>
        </center>
        <div style="padding: 3px;">
            ...
            <button type="button" class="confirm-button saveBtn" onclick="RescheduleInterviewOLD()">
                <i class="ri-check-fill"></i>
                <span>Confirm</span>
            </button>
        </div>
