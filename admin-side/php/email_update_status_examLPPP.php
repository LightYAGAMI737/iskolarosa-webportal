...
function sendEmailInterview($email, $control_number, $status, $examDate)
{
    ...
    <body>
        ...
        <div>Congratulations once again on advancing to the <strong>'.  $status . '</strong> stage. You\'re set to have an Exam on ' . $examDate . ' .</strong></div>
        <br>
        <div>Please note that the Exam location details will be posted on our announcement page. Kindly check the page for the specific venue information. We recommend reviewing this information before your scheduled exam.</div>
        <br>
        <div>To ensure a smooth process, we encourage all applicants to arrive at the exam location a bit earlier than the scheduled time.</div>
        <br>
        <div>
