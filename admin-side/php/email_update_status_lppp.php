...
function sendEmail($email, $control_number, $status)
{
    ...
    <body>
        ...
        <div>As part of our scholarship application review process, we are pleased to inform you that your application status has been updated to <strong>'.  $status .'</strong>. This indicates that the registration form you submitted has been carefully reviewed and verified by the Scholarship Office.</strong></div>
        <br>
        <div>We kindly request that you stay tuned for future updates on your application status.</div>
        <br>
        <div>
