...
function sendEmail($email, $control_number)
{
    require_once 'PHPMailerConfigure.php';
    ...
    $mail->Subject = 'Update on your personal information';
    ...
    <div>We want to inform you that there have been updates to your scholarship application information. If you\'re not aware of the changes, please visit the Scholarship Office; otherwise, disregard this notification.</div>
    <br>
    ...
    <br>
    <div>Thank you for your cooperation, and we look forward to assisting you further in your scholarship journey.</div>
    <br>
    <div>Warm Regards,<br>
