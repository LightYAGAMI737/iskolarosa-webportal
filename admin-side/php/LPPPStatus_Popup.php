...
<!-- Exam Score popup  -->
<div class="popupOut" id="openExamScorePopup">
    <div class="popupIn">
        <i class="ri-question-fill" style="font-size: 6em; color: #F54021;"></i>
        <strong>
        ...
        <div style="padding: 3px;">
            ...
            <button type="submit" class="confirm-button" name="submit" id="ScoreFormBTN">
                <i class="ri-check-fill"></i>
                <span>Confirm</span>
            </button>
        </div>
...
<!-- Grantee popup  -->
<div class="popupOut" id="openLPPPGranteePopup">
    <div class="popupIn">
        <i class="ri-question-fill" style="font-size: 6em; color: #F54021;"></i>
        <strong>
            <h2>Update Applicant Status?</h2>
        ...
        <div style="padding: 3px;">
            ...
            <button type="submit" class="confirm-button" name="submit" onclick="updateStatusLPPP('Grantee', <?php echo $id; ?>)">
                <i class="ri-check-fill"></i>
                <span>Confirm</span>
            </button>
        </div>
...
<!-- Fail popup  -->
<div class="popupOut" id="LPPPFailPopUp">
    <div class="popupIn">
        <i class="ri-question-fill" style="font-size: 6em; color: #F54021;"></i>
        <strong>
            <h2>Update Applicant Status?</h2>
        ...
        <div style="padding: 3px;">
            ...
            <button type="submit" class="confirm-button" name="submit" id="LPPPFailconfirmButton" >
    <i class="ri-check-fill"></i>
    <span>Confirm</span>
</button>
...
<div class="popupOut" id="RescheduleINTERVIEWPopUp">
 ...
 <!-- confirmation EXAM of updated status -->
