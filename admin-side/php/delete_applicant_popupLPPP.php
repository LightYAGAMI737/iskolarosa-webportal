<!-- Delete popup -->
<div class="popupOut" id="DeleteApplicantLPPP">
    <div class="popupIn">
        ...
        <div style="padding: 3px;">
            ...
            <button type="submit" class="confirm-button" name="submit" onclick="deleteApplicantLPPP(<?php echo $id; ?>)">
 ...
 <div class="popupOut" id="ConfrimMsgDeleteApplicantLPPP">
    <div class="popupIn">
