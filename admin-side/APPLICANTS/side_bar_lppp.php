...
<aside id="sidebar" class="sidebar break-point-sm has-bg-image">
   ...
   <div class="sidebar-layout">
    ...
    <div class="sub-menu-list">
            <ul>
                <li class="menu-item">
                    <a href="../LPPP/lppp_list.php" <?php if ($currentSubPage === 'GRADE 7') echo 'class="active"'; ?>>
                        <span class="menu-title">Grade 7</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="../LPPP/grade_8_list.php" <?php if ($currentSubPage === 'GRADE 8') echo 'class="active"'; ?>>
                        <span class="menu-title">Grade 8</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="../LPPP/grade_9_list.php" <?php if ($currentSubPage === 'GRADE 9') echo 'class="active"'; ?>>
                        <span class="menu-title">Grade 9</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="../LPPP/grade_10_list.php" <?php if ($currentSubPage === 'GRADE 10') echo 'class="active"'; ?>>
                        <span class="menu-title">Grade 10</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="../LPPP/grade_11_list.php" <?php if ($currentSubPage === 'GRADE 11') echo 'class="active"'; ?>>
                        <span class="menu-title">Grade 11</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="../LPPP/grade_12_list.php" <?php if ($currentSubPage === 'GRADE 12') echo 'class="active"'; ?>>
    ...
    <?php } else if ($_SESSION['role'] !== 2) {
        ...
        ?>
        <li class="menu-item">
           <a href="../LPPP/lppp_list.php" <?php if ($currentPage === 'lppp_list') echo 'class="active"'; ?>>
           <span class="menu-icon">
