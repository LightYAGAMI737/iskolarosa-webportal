<?php
   ...
   WHERE  t.status = 'interview' AND t.interview_date != '0000-00-00';
               ...
               <?php
                  $counter = 1;
                           ...
                           while ($row = mysqli_fetch_assoc($result)) {
                              ...
                              echo '<tr class="applicant-row contents" data-interview-date="' . $row['interview_date'] . '" onclick="seeMore(\'' . $row['lppp_reg_form_id'] . '\')" style="cursor: pointer;">';
